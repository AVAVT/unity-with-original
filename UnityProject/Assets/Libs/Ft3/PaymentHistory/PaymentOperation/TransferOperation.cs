...
namespace Chromia.Postchain.Ft3
{
  public class TransferOperation
  {
    ...
    public static TransferOperation From(dynamic rawTransfer)
    {
      ...
      {
        inputs.Add(
            new TransferParam(PostchainUtil.ByteArrayToString(input[0]), PostchainUtil.ByteArrayToString(input[1]), (int)input[3])
        );
      }
      ...
      {
        outputs.Add(
            new TransferParam(PostchainUtil.ByteArrayToString(input[0]), PostchainUtil.ByteArrayToString(input[1]), (int)input[2])
        );
      }
