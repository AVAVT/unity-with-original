  ...
  public class SingleSignatureAuthDescriptor : AuthDescriptor
  {
    ...
    public dynamic[] ToGTV()
    {
      var gtv = new List<dynamic>(){
        ...
        new List<string>(){PostchainUtil.ByteArrayToString(this._pubkey)}.ToArray(),
        new List<dynamic>(){this.Flags.ToGTV(), PostchainUtil.ByteArrayToString(this._pubkey)}.ToArray(),
        this.AuthRule?.ToGTV()
      };
